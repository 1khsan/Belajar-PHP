...
//atribut berfungsi sebagai informasi tambahan
//yang bisa ditaruh di property,class,function dll
class LoginRequest
{
    #[Length(min: 4, max: 10)]
    #[NotBlank]
...
{
    $attributes = $property->getAttributes(NotBlank::class);//ditangkap berupa array
...
function validateLength(ReflectionProperty $property, object $object): void
{
    ...
    foreach ($attributes as $attribute) {
        $length = $attribute->newInstance();//membuat objek dari atribut yg sudah di definisikan
...
//fungsi validate memanggil kelas reflection
//dan fungsi validatenotblank dan validate lenght
// memnaggil atributnya
$request = new LoginRequest();
$request->username = "eko123";
$request->password = "ihsan77_";
validate($request);